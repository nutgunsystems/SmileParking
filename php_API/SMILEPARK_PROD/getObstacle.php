...
if (isset($_GET)) {
	if ($_GET['isAdd'] == 'true') {
		...
		if ($car_id != '')  {
			...
			$query =  "SELECT * FROM obstacleTable WHERE ref_car_id = '$car_id' and issue_date = '$issue_date' and expire_status = '0' and  acknowledge_status = '0' and ref_station_id = '$station_id' ";
		} elseif ($obstacle_id != '')  {
			//find by obstacle id
	...
	} else echo "Welcome get Obstacle function [PROD]";	// if2
